...
if __name__ == "__main__":
    ...
    set_logger(os.path.join('.', 'train_5folds_fc.log')) # logger
    
    start_time = time.time()
    
    # train 5-folds
    for i in range(5):
        build_train_validate('annotated_videos_w_folds.csv', test_fold=i, model_type='FC')
        ...
        for desc in desc_list:
            ...
            params.train_path = 'train_FC.csv'
            params.validation_path = 'validation_FC.csv'
            params.prediction_path = 'test_FC.csv'
